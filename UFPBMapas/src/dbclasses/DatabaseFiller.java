...
public class DatabaseFiller {
	...
	public void databaseFillerRoute(DataHandler dh) {
		...
		dh.insertRoute(++id, dh.getIdFromAcronym("CT"), dh.getIdFromAcronym("CEAR"), R.drawable.rota_ct_cear, 164, "Siga em direção à rotatória\nSiga em frente e a Entrada do CEAR estará à esquerda");
		dh.insertRoute(++id, dh.getIdFromAcronym("CEAR"), dh.getIdFromAcronym("CCJ"), R.drawable.rota_ccj_cear, 165, "Siga em frente em direção à rotatória mais distante\nChegando lá, o prédio estará à sua direita");
		dh.insertRoute(++id, dh.getIdFromAcronym("CCJ"), dh.getIdFromAcronym("CA"), R.drawable.rota_ccj_ca, 50, "Atravesse a rua em direção aos prédios enfileirados em frente ao estacionamento");
		dh.insertRoute(++id, dh.getIdFromAcronym("CCJ"), dh.getIdFromAcronym("CCSA"), R.drawable.rota_ccj_ccsa, 61, "Atravesse a rua em direção ao prédio do lado oposto ao estacionamento.");
		dh.insertRoute(++id, dh.getIdFromAcronym("CA"), dh.getIdFromAcronym("CCSA"), R.drawable.rota_ca_ccsa, 79, "Certifique-se que está entre os primeiros quatro blocos\nAtravesse a rua em direção aos prédios do lado oposto ao estacionamento");
		dh.insertRoute(++id, dh.getIdFromAcronym("CCSA"), dh.getIdFromAcronym("CE"), R.drawable.rota_ccsa_ce, 123, "Siga em direção a rotatória mais distantes\nSerão os prédios mais próximos");
		dh.insertRoute(++id, dh.getIdFromAcronym("CE"), dh.getIdFromAcronym("CCHLA"), R.drawable.rota_ce_cchla, 91, "Observe a placa denominada CCHLA\nAnde em direção a ela.");
		dh.insertRoute(++id, dh.getIdFromAcronym("CCHLA"), dh.getIdFromAcronym("Rotatoria1"), R.drawable.rota_cchla_rotatoria, 58, "Siga em frente até a rotatória mais próxima");
		dh.insertRoute(++id, dh.getIdFromAcronym("Rotatoria1"), dh.getIdFromAcronym("Concert Hall"), R.drawable.rota_rotatoria_concerthall, 56, "Siga em direção à entrada da UFPB\nO prédio estará à sua direita");
		dh.insertRoute(++id, dh.getIdFromAcronym("Rotatoria1"), dh.getIdFromAcronym("CCTA"), R.drawable.rota_cta_rotatoria, 150, "Siga em frente na direção oposta da entrada da UFPB\nVire à esquerda na primeira rua\n Os prédios estarão à sua esquerda");
		dh.insertRoute(++id, dh.getIdFromAcronym("Rotatoria1"), dh.getIdFromAcronym("RU"), R.drawable.rota_ru_rotatoria, 222, "Siga em frente na direção oposta à entrada da UFPB\nO prédio estará à sua esquerda, logo antes do estacionamento");
		dh.insertRoute(++id, dh.getIdFromAcronym("RU"), dh.getIdFromAcronym("Centro de Vivência"), R.drawable.rota_ru_centro_de_vivencia, 48, "Note a praça coberta em frente ao restaurante\nSiga até esse ponto");
		dh.insertRoute(++id, dh.getIdFromAcronym("Centro de Vivência"), dh.getIdFromAcronym("CODISMA"), R.drawable.rota_centrodevivencia_codisma, 42, "De frente ao resturante, vire à direita");
		dh.insertRoute(++id, dh.getIdFromAcronym("CODISMA"), dh.getIdFromAcronym("TV UFPB"), R.drawable.rota_codisma_tvufpb, 135, "Siga em linha reta em direção ao gazebo\nAtravesse a rua");
		dh.insertRoute(++id, dh.getIdFromAcronym("TV UFPB"), dh.getIdFromAcronym("Baratão"), R.drawable.rota_baratao_tvufpb, 75, "Siga em frente na direção da Caixa\nVire à direita na primeira entrada");
		dh.insertRoute(++id, dh.getIdFromAcronym("TV UFPB"), dh.getIdFromAcronym("Caixa"), R.drawable.rota_tvufpb_caixa, 151, "De costas à entrada, siga à direita\nO prédio estará à sua direita");
		dh.insertRoute(++id, dh.getIdFromAcronym("CCTA"), dh.getIdFromAcronym("Caixa"), R.drawable.rota_cta_caixa, 170, "Siga em frente paralelamente à reserva\nAo final da rua, o prédio estará à sua frente");
		dh.insertRoute(++id, dh.getIdFromAcronym("Rotatoria1"), dh.getIdFromAcronym("Caixa"), R.drawable.rota_caixa_rotatoria, 255, "Siga beirando os limites do campus até a passarela coberta\nSiga em frente até a rotatória");
		dh.insertRoute(++id, dh.getIdFromAcronym("Baratão"), dh.getIdFromAcronym("Caixa"), R.drawable.rota_baratao_caixa, 148, "Siga até a saída da rua\nEntre à direita\nO prédio estará na sua direita");
		dh.insertRoute(++id, dh.getIdFromAcronym("TV UFPB"), dh.getIdFromAcronym("Setor de Vigilância"), R.drawable.rota_setordevigilancia_tvufpb, 164, "De costas para o prédio, siga à sua esquerda\nO prédio estará à sua esquerda");
		dh.insertRoute(++id, dh.getIdFromAcronym("Setor de Vigilância"), dh.getIdFromAcronym("Rotatoria2"), R.drawable.rota_setordevigilancia_rotatoria, 127, "De costas para o prédio, siga à sua esquerda\nA rotatória estatrá logo à frente");
		dh.insertRoute(++id, dh.getIdFromAcronym("Rotatoria2"), dh.getIdFromAcronym("Reitoria"), R.drawable.rota_reitoria_rotatoria, 110, "De costas à entrada do campus, siga em frente\nO prédio estará à sua direita");
		dh.insertRoute(++id, dh.getIdFromAcronym("Rotatoria2"), dh.getIdFromAcronym("Setor Esportivo"), R.drawable.rota_setoresportivo_rotatoria, 167, "De costas para a entrada do campus, siga à esquerda\nA entrada estará à sua esquerda");
		dh.insertRoute(++id, dh.getIdFromAcronym("Reitoria"), dh.getIdFromAcronym("NTI"), R.drawable.rota_nti_reitoria, 75, "De costas para a entrada, siga à direita\nAtravesse a rua\nO prédio estará à sua esquerda");
		dh.insertRoute(++id, dh.getIdFromAcronym("Reitoria"), dh.getIdFromAcronym("UFPB Virtual"), R.drawable.rota_reitoria_ufpbvirtual, 61, "Atravesse o estacionamento em frente ao prédio\nO prédio estará à sua frente");
		dh.insertRoute(++id, dh.getIdFromAcronym("RU"), dh.getIdFromAcronym("Banco do Brasil"), R.drawable.rota_bb_ru, 116, "Siga a calçada, passando pelo Centro de Vivência\nO prédio estará à sua esquerda");
		dh.insertRoute(++id, 6, dh.getIdFromAcronym("Banco do Brasil"), R.drawable.rota_bb_centrodevivencia, 77, "Dentro do Centro de Vivências, desça as escadas\nSiga em frente\nNa saída à sua direita, siga à esquerda\nO prédio estará à sua esquerda");
		dh.insertRoute(++id, dh.getIdFromAcronym("Banco do Brasil"), 7, R.drawable.rota_bb_bibliotecacentral, 44, "Atravesse a rua\nO prédio estará à sua frente");
		...
		dh.insertRoute(++id, 26, dh.getIdFromAcronym("CEB"), R.drawable.rota_ceb_goledafruta, 276, "De costas para a lanchonete, siga à direita\nMais à frente, o prédio estará à sua esquerda");
		dh.insertRoute(++id, 10, dh.getIdFromAcronym("CEB"), R.drawable.rota_ceb_setoresportivo, 413, "De costas para a entrada, siga à esquerda\nEntre na primeira à direita\nSiga até o final da rua\nEntre à esquerda\nO prédio estará à sua esquerda");
		...
		dh.insertRoute(++id, dh.getIdFromAcronym("CEB"), 11, R.drawable.rota_ccs_ceb, 126, "De costas para o prédio, siga à esquerda\nOs prédios estarão à sua direita");
		dh.insertRoute(++id, dh.getIdFromAcronym("CEB"), 12, R.drawable.rota_ceb_hu, 164, "De costas para o prédio, siga à esquerda\nO prédio estará à sua frente");
		...
		dh.insertRoute(++id, dh.getIdFromAcronym("CA"), 24, R.drawable.rota_ca_lando, 145, "Certifique-se que está no começo do Bloco A\n Acompanhe-o até o estacionamento ao final do bloco\nA lanchonete estará à sua frente");
		...
		dh.insertRoute(++id, 22, dh.getIdFromAcronym("RU"), R.drawable.rota_ru_cta, 169, "De costas para o prédio, siga à direita\nAo final da rua, entre à esquerda\n Mais à frente, o prédio estará à sua esquerda");		
		
		//Invertendo		
		dh.insertRoute(++id, dh.getIdFromAcronym("CEAR"), dh.getIdFromAcronym("CT"), R.drawable.rota_ct_cear, 164, "Siga em frente em direção à rotatória da entrada da UFPB\nEntre à esquerda na rotatória\nSiga em frente e o conjunto de prédios estará à sua esquerda");
		dh.insertRoute(++id, dh.getIdFromAcronym("CCJ"), dh.getIdFromAcronym("CEAR"), R.drawable.rota_ccj_cear, 165, "Da rotatória em frente ao prédio, siga em direção à rotatória da entrada da UFPB\nO prédio estará á sua direita, antes de chegar a rotatória");
		dh.insertRoute(++id, dh.getIdFromAcronym("CA"), dh.getIdFromAcronym("CCJ"), R.drawable.rota_ccj_ca, 50, "Certifique-se que está no Bloco A\nAtravesse a rua até o prédio em frente à rotatória");
		dh.insertRoute(++id, dh.getIdFromAcronym("CCSA"), dh.getIdFromAcronym("CCJ"), R.drawable.rota_ccj_ccsa, 61, "Siga até a rotatória mais próxima\nAtravesse a rua em direção ao prédio de frente a ela");
		dh.insertRoute(++id, dh.getIdFromAcronym("CCSA"), dh.getIdFromAcronym("CA"), R.drawable.rota_ca_ccsa, 79, "Atravesse a rua em direção ao conjunto de prédios enfileirados");
		dh.insertRoute(++id, dh.getIdFromAcronym("CE"), dh.getIdFromAcronym("CCSA"), R.drawable.rota_ccsa_ce, 123, "Observe a placa denominada CCSA\nAnde em direção a ela");
		dh.insertRoute(++id, dh.getIdFromAcronym("CCHLA"), dh.getIdFromAcronym("CE"), R.drawable.rota_ce_cchla, 91, "Siga na direção oposta à rotatória mais próxima\nSerá o próximo conjunto de prédios");
		dh.insertRoute(++id, dh.getIdFromAcronym("Rotatoria1"), dh.getIdFromAcronym("CCHLA"), R.drawable.rota_cchla_rotatoria, 58, "Observe a placa denominada CCHLA\nAnde em direção a ela");
		dh.insertRoute(++id, dh.getIdFromAcronym("Concert Hall"), dh.getIdFromAcronym("Rotatoria1"), R.drawable.rota_rotatoria_concerthall, 56, "Siga até a rotatória mais próxima");
		dh.insertRoute(++id, 22, dh.getIdFromAcronym("Rotatoria1"), R.drawable.rota_cta_rotatoria, 150, "Siga em frente em direção à principal\nVire à direita\nSiga em frente em direção à rotatória");
		dh.insertRoute(++id, dh.getIdFromAcronym("RU"), dh.getIdFromAcronym("Rotatoria1"), R.drawable.rota_ru_rotatoria, 222, "Siga em frente na direção oposta ao estacionamento\nSerá a primeira rotatória, em frente à entrada da UFPB");
		dh.insertRoute(++id, dh.getIdFromAcronym("Centro de Vivência"), 16, R.drawable.rota_ru_centro_de_vivencia, 48, "Note o conjunto de entradas que levam ao prédio cheio de mesas\nÉ esse prédio mesmo");
		dh.insertRoute(++id, 15, dh.getIdFromAcronym("Centro de Vivência"), R.drawable.rota_centrodevivencia_codisma, 42, "Observe o pátio coberto\nSiga até ele");
		...
		dh.insertRoute(++id, dh.getIdFromAcronym("Caixa"), 28, R.drawable.rota_tvufpb_caixa, 151, "Siga em frente na pista principal\nO prédio estará à sua esquerda");
		dh.insertRoute(++id, dh.getIdFromAcronym("Caixa"), 22, R.drawable.rota_cta_caixa, 170, "Siga à rua em frente ao prédio\nO conjunto de prédios estará à sua direita");
		dh.insertRoute(++id, dh.getIdFromAcronym("Caixa"), dh.getIdFromAcronym("Rotatoria1"), R.drawable.rota_caixa_rotatoria, 255, "De costas à entrada da UFPB, entre à esquerda\nSiga a passarela coberta\nEntre a direita\nO prédio estará à sua esquerda, em frente ao estacionamento");
		dh.insertRoute(++id, dh.getIdFromAcronym("Caixa"), 27, R.drawable.rota_baratao_caixa, 148, "Siga em frente na rua principal\nEntre à esquerda na primeira esquina");
		dh.insertRoute(++id, 14, 28, R.drawable.rota_setordevigilancia_tvufpb, 164, "De costas para o prédio, siga à direita\nO prédio estará à sua direita");
		dh.insertRoute(++id, dh.getIdFromAcronym("Rotatoria2"), 14, R.drawable.rota_setoresportivo_rotatoria, 127, "De costas para a entrada do campus, siga à sua direita\nO prédio estará à sua direita");
		dh.insertRoute(++id, 9, dh.getIdFromAcronym("Rotatoria2"), R.drawable.rota_reitoria_rotatoria, 110, "De costas para o prédio, siga à esquerda\nA rotatória estará logo à frente");
		dh.insertRoute(++id, 10, dh.getIdFromAcronym("Rotatoria2"), R.drawable.rota_setoresportivo_rotatoria, 167, "De costas para a entrada, siga à direita\nA rotatória estará logo à frente");
		...
		dh.insertRoute(++id, dh.getIdFromAcronym("Banco do Brasil"), 16, R.drawable.rota_bb_ru, 116, "De costas para o prédio, siga à direita\nO prédio esta´ra à sua frente");
		dh.insertRoute(++id, dh.getIdFromAcronym("Banco do Brasil"), 6, R.drawable.rota_bb_centrodevivencia, 77, "De costas para o prédio, siga à direita\nA entrada do prédio estará à sua direita");
		dh.insertRoute(++id, 7, dh.getIdFromAcronym("Banco do Brasil"), R.drawable.rota_bb_bibliotecacentral, 44, "Atravesse a rua\nO prédio estará à sua frente");
		...
		dh.insertRoute(++id, dh.getIdFromAcronym("CEB"), 26, R.drawable.rota_ceb_goledafruta, 276, "De costas para o prédio, siga à direita\nMais à frente, o prédio estará à sua esquerda");
		dh.insertRoute(++id, dh.getIdFromAcronym("CEB"), 10, R.drawable.rota_ceb_setoresportivo, 413, "De costas para o prédio, siga à direita\nEntre na primeira à direita\nSiga até o fim da rua\nEntre à esquerda\nMais à frente, a entrada estará à sua direita");
		...
		dh.insertRoute(++id, 11, dh.getIdFromAcronym("CEB"), R.drawable.rota_ccs_ceb, 126, "De costas para o prédio, siga à esquerda\nEntre à esquerda\nMais à frente, o prédio estará à sua direita");
		dh.insertRoute(++id, 12, dh.getIdFromAcronym("CEB"), R.drawable.rota_ceb_hu, 164, "De costas para o prédio, siga à esquerda\nO prédio estará à sua direita");
		...
		dh.insertRoute(++id, 24, dh.getIdFromAcronym("CA"), R.drawable.rota_ca_lando, 145, "Siga até o estacionamento\nO conjunto de prédios estará á sua frente");
		...
		dh.insertRoute(++id, dh.getIdFromAcronym("RU"), 22, R.drawable.rota_ru_cta, 169, "De costas para o restaurante, siga à direita\nEntre na primeira à direita\nOs prédios estarão à sua esquerda");		
