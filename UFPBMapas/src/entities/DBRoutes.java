...
public class DBRoutes {
	 ...
	 * @param description
	 */
	public void addRoute(int id, int sourceId, int destinationId, int map, String instruction, int dist){
		Route aux = new Route(id, sourceId, destinationId, map, instruction, dist);
		routes.add(aux);
	}
