...
public class DatabaseFiller {
	...
	public static void databaseFillerLdm() {
		...
		DBLandmark.getInstance().addLdm(3, "Centro de Ciências Sociais Aplicadas - CCSA", R.drawable.ccsa, "Centro que oferece diversos cursos de áreas humanas, incluindo adminstração.");
		DBLandmark.getInstance().addLdm(4, "Centro de Educação - CE", R.drawable.ce, "");
		DBLandmark.getInstance().addLdm(5, "Centro de Ciências Humanas, Letras e Artes - CCHLA", R.drawable.cchla, "Centro que oferece diversos cursos, entre eles, Pedagogia, Psicopedagogia e Ciências das Religião");
		DBLandmark.getInstance().addLdm(6, "Centro de Vivência", R.drawable.centro_de_vivencia, "Local de confraternização da UFPB");
		...
		DBLandmark.getInstance().addLdm(15, "CODISMA", R.drawable.codisma, "");
		...
		DBLandmark.getInstance().addLdm(23, "Centro de Ciências Jurídicas", R.drawable.ccj, "");
	}
